...
namespace MIDterm
{
    ...
    {
        //計算Table的欄位
        public static int datay(SqlConnection 資料庫, string SQL指令)
        {
            int a = 0;
            資料庫.Open();
        ...
        //計算Table的資料數
        public static int datax(SqlConnection 資料庫, string SQL指令)
        {
            int a = 0;
            資料庫.Open();
            SqlCommand com1 = new SqlCommand(SQL指令, 資料庫);
        ...
        //查詢用建構子
        public static string[,] search(SqlConnection 資料庫, string SQL指令)
        {
            資料庫.Open();
