    ...
    public partial class Form1 : Form
    {
        ...
        private void btn買一送一_Click_1(object sender, EventArgs e)
        {
               ...
               (tb杯數4.Text.Length > 0) || (tb杯數5.Text.Length > 0))
            {
                ...
                else if ((tb杯數1.Text.Length == 0) && (tb杯數2.Text.Length > 0) && (tb杯數3.Text.Length == 0) &&
                    (tb杯數4.Text.Length == 0) && (tb杯數5.Text.Length == 0))
        ...
        void 不同品項買一送一()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if(杯數3 > 剩餘杯數3)
                    {
                        折扣後總價 = 總價 - (杯數1 * 售價1) - (剩餘杯數2 * 售價2)-(剩餘杯數3 * 售價3);
                    }
                    else
                    {
                        剩餘杯數4 = 剩餘杯數3-杯數3;
                        if (杯數4 > 剩餘杯數4)
                        {
                            折扣後總價 = 總價 - (杯數1 * 售價1) - (剩餘杯數2 * 售價2) - (剩餘杯數3 * 售價3)- (剩餘杯數4 * 售價4);
                        ...
                        else
                        {
                            ...
                            if(杯數5 > 剩餘杯數5)
                            {
                                折扣後總價 = 總價 - (杯數1 * 售價1) - (剩餘杯數2 * 售價2) - (剩餘杯數3 * 售價3) - (剩餘杯數4 * 售價4)-(剩餘杯數5 * 售價5);
                            }
                        }
                    }
                }
